...
import com.example.shopapp2.domain.use_case.GetShoesProductsUseCase
...
@Inject
constructor(
    private val getShoesProductsUseCase: GetShoesProductsUseCase
) : ViewModel() {
    ...
    fun loadDataForFirstTime() {
        viewModelScope.launch {
            ...
            val mostPopularProductsNetworkResult = getShoesProductsUseCase.getData(
